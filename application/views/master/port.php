...
<html lang="en">
  <head>    
        ...
        $(document).ready(function(){
            ...
            function IsValidTextField(){
                ...
                if ($("#port_name").val() == "" || $("#port_name").val() == null) {
                    ...
                    $("#invalid-feedback-port-name").append("This Port Name field is required")
            ...
            $("#btnSimpan").click(function(){
                if (!IsValidTextField()){
                    ...
                    $.ajax({
                        method :"post",
                        url : "<?= base_url("apiport/update_data_port") ?>",
                        dataType:"json",
                        data : data,
                        async : false,
                        headers: {
    ...
    <script type="text/javascript">
        ...
        function SetDataViewPort(){
            $('#myModalSpinnerPleaseWait').modal({backdrop: 'static', keyboard: false});
            table_port.destroy();
            table_port = $("#table-port").DataTable({
                "ajax" : {
                ...
                "columns" : [
                    {data :  null,
                        render : (data) =>{
                        return '<input type="checkbox" class="form-control-sm selected-row" value="'+data.port_code+'" onchange="OnChangeSelectedRow()">';
                        }
                    },
                    {data :  null,
                        render : (data) =>{
                    ...
                    {data :  null,
                        render : (data) =>{
                            id = data.port_code
                            param = data.port_code+";"+data.port_name
                            ...
                            html += "<button class='dropdown-item' onclick='changesPortName(\""+param+"\")'><i class='fas fa-edit text-primary'></i> <span class='mx-2 text-primary'>Edit Data</span></button>";
                            html += "<button class='dropdown-item' onclick='deletePort("+id+")'><i class='fas fa-times text-danger'></i> <span class='mx-2 text-danger'>Hapus Data</span></div>";
                            html += '</div>'
                            html += '</div>'
                            return html
                        }
        ...
        function ClearFormPort(){
            $("#invalid-feedback-port-name").empty();
            $("#port_name").removeClass("form-control is-invalid").addClass("form-control");
            $("#port_name").removeClass("form-control is-valid").addClass("form-control");
            $("#port_name").val("");
            $("#port_code").val("");
        }
        function changesPortName(params){
            ClearFormPort();
            var datas = params.split(";");
            $("#port_code").val(datas[0]);
            $("#port_name").val(datas[1]);
            $("#modalFormPort").modal("show");
            $("#port_name").focus();
        }
        ...
        function deletePort(id){
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        method :"post",
                        url : "<?= base_url("apiport/delete_data_port/") ?>",
                        dataType:"json",
                        data : data,
                        async : false,
                        headers: {
  ...
  <body class="c-app">
    ...
    <div class="c-wrapper c-fixed-components">
      ...
      <div class="c-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="card-title mb-0 text-primary">Port</h4>
                            </div>
                            <div >
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="table-responsive">
                                                <table class="table table-striped " id="table-port">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="bg-primary text-white">Port Name</th>
        ...
        <div class="modal" id="modalFormPort" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable  modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="text-white"><span class="fas fa-edit"></span> <span class="mx-2">Edit Port</span></h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="port_name" name="port_name" class="form-control">
