            ...
            <div class="col-sm-7">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url("user/update") ?>" class="form-horizontal" id="form-user" method="post">
                            <div class="form-group row">
                                <label for="" class="col-sm-4">Username</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm" readonly id="username" maxlength="50" name="username" value="<?= $username ?>">
